...
import { Bot, Send, FileText, Camera, Paperclip, Clock, CheckCircle2, AlertCircle } from "lucide-react";
import { AppTab, ShiftState, CustomDataMessage } from "./useSkillOnboardingBot";
import { Message } from "@ai-sdk/react";

interface SkillOnboardingPhoneProps {
    activeTab: AppTab;
    ...
    isLoading: boolean;
    customMessages: Record<string, CustomDataMessage>;
    messagesEndRef: React.RefObject<HTMLDivElement | null>;
}

export function SkillOnboardingPhone({
    activeTab,
    setActiveTab,
    shiftState,
    clockInTime,
